                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                               <div class="form-check">
                                    <input type="radio" name="gender" value="m" class="from-check-input" required>
                                    <label class="form-check-label">ชาย</label>
                               </div>
                               <div class="form-check">
                                    <input type="radio" name="gender" value="f" class="from-check-input" required>
                                    <label class="form-check-label">หญิง</label>
                               </div>
                               <div class="form-check">
                                    <input type="radio" name="gender" value="o" class="from-check-input" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <button class="btn btn-primary btn-sm" type="submit">
                                    <i class="bi bi-save-fill me-1"></i>สมัครสมาชิก
                                </button>
                            </div>
                        </div>
                    </form>
